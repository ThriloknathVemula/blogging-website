    ...
    return(
        <div>
            ...
            <div className="blog-details flex flex-col items-center mx-auto mt-3 w-3/5">
                <h1 className="font-bold text-xl md:font-extrabold md:text-5xl mt-2">{title}</h1>
                ...
                <h1 className="font-medium text-md mt-1 text-slate-400">Date published: 07-07-2024</h1>
